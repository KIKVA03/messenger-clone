                    ...
                    <div className="fixd inset-0 overflow-hidden">
                        <div className="absolute inset-0 overflow-hidden">
                            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                                <Transition.Child
                                    as={Fragment}
                                    enter="transform transition ease-in-out diuration-500"
                                    enterFrom="translate-x-full"
                                    enterTo="transition-x-0"
                                    leave="transform transition ease-in-out diuration-500"
                                                        ...
                                                        <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                            {data.isGroup && (
                                                                <div className="">
                                                                    ...
                                                                    <dd className="mt-1 text-sm text-gray-900 sm:coll-span-2">
                                                                        {data.users
                                                                            .map(
                                                                                (user) => user.email
                                                                            )
